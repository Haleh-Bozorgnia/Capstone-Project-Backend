"""
Django settings for saleserviceproject project.
...
INSTALLED_APPS = [
    ...
    "saleservices.apps.SaleservicesConfig",
    "rest_framework",
    "corsheaders",
]
...
ROOT_URLCONF = 'saleserviceproject.urls'
...
WSGI_APPLICATION = 'saleserviceproject.wsgi.application'
